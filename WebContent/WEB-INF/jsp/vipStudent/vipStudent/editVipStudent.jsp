	...
	<form id="vipStudentFormEdit">
		<div class="ui-table ui-widget ui-corner-all ui-border">
			...
			<table class="table">
				...
				<tr>
					<td class="inputLabelTd"><span class="required">*</span>微信号：</td>
				...
				<tr>
					<td class="inputLabelTd"><span class="required">*</span>支付宝账号：</td>
...
// 			addAccountFlow();
	...
	new biz.validate({
		...
		rules:{
			"name" :{required : true},
			"payAccount" :{required : true},
			"eduBack" :{required : true},
			"qqNick" :{required : true},
			"qq" : {required : true,number:true,rangelength:[6,12],digits:true },
			"phone" :{required : true},
