...
<div class="sidebar" id="sidebar">
	...
	<ul class="nav nav-list">
		<li id="fhindex" class="active"><a href="javaScript:;"
			onClick="document.getElementById('iframepage').src ='adminHomePage.do';">
				<i class="icon-dashboard"></i> <span class="menu-text"> 后台首页
			</span>
		</a></li>
