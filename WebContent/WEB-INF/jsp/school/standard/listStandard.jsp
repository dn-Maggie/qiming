...
<body style="height: 100%;">
	...
	<div class="main  choice_box">
		<form id="queryForm">
			...
			<div class="search border-bottom">
				<ul>
					...
					<!-- 输入框-->
					<li><span>统计方式:</span> <select class="search_choose"
						name="groupBy" id="groupBy" mainid="groupBy">
		...
		<div class="listplace">
			...
			<div id="total"
				style="position: relative; bottom: 0px; width: 800px; left: 50%; margin-left: -400px; z-index: 20">
				...
				<div class="bottomStatistic">
					本月应收总额： <span id="shouldPay"> <%-- 							<fmt:formatNumber value="${model.curr.shouldPay}" pattern="0" type="number"></fmt:formatNumber> --%>
					</span>
				</div>
				<div class="bottomStatistic">
					本月退款总额： <span id="xftk"> <%-- 							<fmt:formatNumber value="${model.currxf.xftk}" pattern="0" type="number"></fmt:formatNumber> --%>
					</span>
				</div>
				<div class="bottomStatistic">
					本月应收欠款： <span id="arrears"> <%-- 							<fmt:formatNumber value="${model.curr.arrears}" pattern="0" type="number"></fmt:formatNumber> --%>
					</span>
				</div>
				<div class="bottomStatistic">
					本月总业绩： <span id="allincome"> <%-- 							<fmt:formatNumber value="${model.currxf.xfsr+model.currxf.xfbk-model.currxf.xftk}" pattern="0" type="number"></fmt:formatNumber> --%>
					</span>
				</div>
				<div class="bottomStatistic">
					本月实收报名费： <span id="xfsr"> <%-- 							<fmt:formatNumber value="${model.currxf.xfsr}" pattern="0" type="number"></fmt:formatNumber> --%>
					</span>
				</div>
				<div class="bottomStatistic">
					本月实收补款： <span id="xfbk"> <%-- 							<fmt:formatNumber value="${model.currxf.xfbk}" pattern="0" type="number"></fmt:formatNumber> --%>
					</span>
				</div>
			</div>
		</div>
