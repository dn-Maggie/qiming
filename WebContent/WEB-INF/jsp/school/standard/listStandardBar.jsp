...
<body style="height: 100%; background-color: #fff">
				...
				<div class="widget-toolbar no-border">
					<ul class="nav nav-tabs tabhd" id="recent-tab">
						<li class="active"><a data-toggle="tab"
							data-target="achievement-tab">月度业绩统计图</a></li>
						<li><a data-toggle="tab" data-target="vipnumber-tab">报名人数统计图</a>
						</li>
						<li><a data-toggle="tab" data-target="recent30-tab">近30天业绩统计图</a>
						</li>
						<li><a data-toggle="tab" data-target="recentThMonth-tab">近3月日业绩累计增长对比图</a>
						</li>
					</ul>
				</div>
			</div>
							...
							<div class="search border-bottom">
								<ul>
									<li style="width: 160px;"><select class="search_choose"
										name="subjectName" id="subjectName" mainid="subjectName"
										style="width: 88px;">
									...
									<li style="width: 300px"><span>月份:</span> <input
										type="text" id="monthChoose" class="search_choose"
										...
										<div class="timeWrapper">
											...
											<div class="btn-area">
												<a href="javascript:0" id="confirm">确定</a> <a
													href="javascript:0" id="reset">清空</a>
											</div>
										</div></li>
									<li><input type="reset" class="reset_btn"
										onclick="resetForm('queryForm');months=[]" value="重置">
									<!-- 重置 --> <input type="button" class="search_btn mr22 "
										onclick="arr=[];ajaxGetStatistic();drawMainChart();"
										value="查询"></li>
									<!-- 查询-->
								</ul>
							</div>
					...
					<div id="vipnumber-tab" class="tab-pane ">
						<form id="queryForm">
							...
							<div class="search border-bottom">
								<ul>
									<li style="width: 160px;"><select class="search_choose"
										name="subjectName" id="subjectName2" mainid="subjectName"
										style="width: 88px;">
											<option value="">全部</option>
											<c:forEach var="subject" items="${subject}">
												<option value="${subject.name}">
									...
									<!-- 输入框-->
									<li style="width: 300px"><span>年份:</span> <input
										style="width: 200px; float: left;" type="text"
										class="search_time150 date-picker" data-date-format="yyyy"
										id="queryTime"></li>
									<li><input type="reset" class="reset_btn"
										onclick="resetForm('queryForm');" value="重置">
									<!-- 重置 --> <input type="button" class="search_btn mr22 "
										onclick="vipNumbersData=[];ajaxGetVipNumver();drawVipNumber();"
										value="查询"></li>
									<!-- 查询-->
								</ul>
							</div>
					...
					<div id="recent30-tab" class="tab-pane">
						<form id="queryForm">
							...
							<div class="search border-bottom">
								<ul>
									<li style="width: 160px;"><select class="search_choose"
										name="subjectName" id="subjectName3" mainid="subjectName"
										style="width: 88px;">
											<option value="">全部</option>
											<c:forEach var="subject" items="${subject}">
												<option value="${subject.name}">
									...
									<li><input type="reset" class="reset_btn"
										onclick="resetForm('queryForm');" value="重置">
									<!-- 重置 --> <input type="button" class="search_btn mr22 "
										onclick="thirtyData=[];ajaxGetThirtyData();drawThirtyData()"
										value="查询"></li>
									<!-- 查询-->
								</ul>
							</div>
					...
					<div id="recentThMonth-tab" class="tab-pane">
						<form id="queryForm">
							...
							<div class="search border-bottom">
								<ul>
									<li style="width: 160px;"><select class="search_choose"
										name="subjectName" id="subjectName4" mainid="subjectName"
										style="width: 88px;">
											<option value="">全部</option>
											<c:forEach var="subject" items="${subject}">
												<option value="${subject.name}">
									...
									<li><input type="reset" class="reset_btn"
										onclick="resetForm('queryForm');" value="重置">
									<!-- 重置 --> <input type="button" class="search_btn mr22 "
										onclick="recentThMonthData=[];ajaxGetRecentThMonthData();drawRecentThMonthData()"
										value="查询"></li>
									<!-- 查询-->
								</ul>
							</div>
	...
	function drawMainChart(){
		...
		var option = {
		    ...
		    color:['#f68484',  '#777', 'rgb(135, 184, 127)','#ae91e1', '#f6ac61', '#c4ccd3'],
		}
